...
fn type_iterator() {
    ...
    // assert_eq!((&library).iter_type::<&String>().map(|visitor| visitor.parent().path().to_string()).collect::<Vec<_>>(), vec!["a::b::c::d::3", "a::b::c::d::2", "a::b::c::d::1", "a::b::c::d", "a::b::c", "a::b", "a"]);
    // assert_eq!((&mut library).iter_type::<&mut String>().map(|visitor| visitor.parent().path().to_string()).collect::<Vec<_>>(), vec!["a::b::c::d::3", "a::b::c::d::2", "a::b::c::d::1", "a::b::c::d", "a::b::c", "a::b", "a"]);
